...
To investigate this, I created a simple multilingual model using PyTorch on the same dataset used for the last post (see [https://adeebnqo.github.io/post/2025-nounclassification](https://adeebnqo.github.io/post/2025-nounclassification)). An overview of the model, with some details dropped for simplicity, is given in the following visualisation:
